        ...
        if($cate_id==117){
            ...
            if(IS_POST){ //提交表单
               ...
               $catid = I('catid');
                ...
                // if(false !== $model->where('catid='.$data['catid'])->save($data)){

                //     $this->success('保存成功！', U('page',array('cate_id'=>$data['catid'])));
